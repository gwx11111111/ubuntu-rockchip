...
if [[ "${MAINLINE}" != "Y" ]]; then
    test -d linux-rockchip || git clone --single-branch --progress -b linux-5.10-gen-rkr6 https://github.com/gwx11111111/linux-rockchip.git linux-rockchip
    cd linux-rockchip
    ...
    test -d linux ||  git clone --single-branch --progress -b v6.6-rc7-rk3588 https://github.com/Joshua-Riek/linux.git --depth=100
    cd linux
